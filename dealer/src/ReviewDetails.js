      ...
      <Row>
        <Col>
          <Row>
            <label>
              Primary Applicant{" "}
              <FaRegEdit onClick={() => setModalShow(true)}> </FaRegEdit>
            </label>
          </Row>
          <Row>
            <p>
          ...
          <Row>{/* <p>{values.DateOfBirth}</p> */}</Row>
          <Row>
            <p>{values.Ssn}</p>
          </Row>
        </Col>
        {values.Individual_Form_Type === "false" && (
          <Col>
            ...
            <Row>{/* <p>{values.DateOfBirthJ}</p> */}</Row>
            <Row>
              <p>{values.SsnJ}</p>
            </Row>
          </Col>

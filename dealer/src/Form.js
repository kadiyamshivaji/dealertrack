              ...
              <form className="container" onSubmit={handleSubmit}>
                  ...
                  <Row gutter={12}>
                    <Col span={12}>
                      <Button
                        name="Individual"
                        className={
                          this.props.selectedSection === "Joint" ? "" : "active"
                        }
                ...
                <div className="form-group">
                  <p>
                    ...
                    to process your appplication and communicate with you about
                    loan.
                  </p>
                  <h3>Required for Identity Verification</h3>
                  <p>
                    If you are not ready to apply for credit and just want to
                    know your rates <a>check them here</a>
                  </p>
                </div>
                <div className="form-group">
                  <input
